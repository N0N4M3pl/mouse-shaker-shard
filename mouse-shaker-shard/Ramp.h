...
class _ramp {
private:
  unsigned int pos, dur, t;  // ramp position, duration and previous time
...
public:
  ...
  // T go(T, unsigned int);                         // ramp to _val, within _dur
  T go(T, unsigned int, ramp_mode);              // ramp to _val, within _dur with ramp_mode
  // T go(T, unsigned int, ramp_mode, loop_mode);  // ramp to _val, within _dur with ramp_mode and loop_mode
  ...
  // void setGrain(unsigned int);                   // set the grain (interval beetween updates)
};
